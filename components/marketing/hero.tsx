...
const badges = [
    ...
    { text: "Fyoia AI CHAT", top: "25%", right: "8%" },
...
const Hero = () => {
    ...
    const badge = "Meet Fyoia AI";
    const description = "All-in-one AI platform for chat, coding, image generation, video creation, and voice agents — powered by Fyoia models.";
