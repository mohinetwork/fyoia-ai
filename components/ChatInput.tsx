...
const MODEL_ICONS: Record<string, React.ReactNode> = {
  ...
  "FYOIA-V1": FYOIA_LOGO,
  "FYOIA-THINK": FYOIA_LOGO,
  "FYOIA-IMG": FYOIA_LOGO,
  "FYOIA-IMG-GEN": FYOIA_LOGO,
  "FYOIA-BETA": FYOIA_LOGO,
  "FYOIA-IMG-V2": FYOIA_LOGO,
  "FYOIA-IMG-PRO": FYOIA_LOGO,
  "FYOIA-VID": FYOIA_LOGO,
};

const TEXT_MODELS = ["FYOIA-V1", "FYOIA-THINK", "FYOIA-ULTRA", "FYOIA-CODE", "FYOIA-FAST"];
const IMAGE_MODELS = [
  "FYOIA-IMG",
  "FYOIA-IMG-GEN",
  "FYOIA-BETA",
...
const VIDEO_MODELS = ["FYOIA-VID"];
const IMAGE_EDITOR_MODELS = ["FYOIA-IMG-V2", "Fyoia-PRO-V2"];
...
interface ChatInputProps {
  ...
  /** When true, lock model selector to FYOIA-V1 for voice-to-voice chat. */
  isVoiceMode?: boolean;
  onImageMarquee?: () => void;
            ...
            <div className="relative min-h-[32px] sm:min-h-[44px]">
              {mode !== "image-enhance" ? (
                ...
                <div className="pt-2 sm:pt-3 pb-2 sm:pb-3 text-[12px] sm:text-sm text-slate-400">
                  Upload an image to enhance with Fyoia AI.
                </div>
              )}
            </div>
