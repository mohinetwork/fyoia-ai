...
const AILoader: React.FC<LoaderProps> = ({ size = 180, text = "Fyoia AI", responsive = false }) => {
    ...
    <div className="flex items-center justify-center overflow-visible">
      <div
        className={`relative flex items-center justify-center font-inter select-none ${
          responsive ? "w-[100px] h-[100px] sm:w-[120px] sm:h-[120px] md:w-[160px] md:h-[160px] lg:w-[190px] lg:h-[190px]" : ""
        }`}
