  ...
  const handlePlanSelect = (planId: string) => {
    ...
    if (planId === 'enterprise') {
      if (typeof window !== 'undefined') {
        const url =
          'https://mail.google.com/mail/?view=cm&fs=1&to=fyoiaaidev@gmail.com&su=Enterprise%20plan%20inquiry&body=Hi%20Fyoia%20AI%20team,%0D%0A%0D%0AI%27m%20interested%20in%20the%20Enterprise%20plan.';
    ...
    >
      ...
      <ResponsiveModal open={proModalOpen} onOpenChange={setProModalOpen}>
        <ResponsiveModalContent side="bottom" className="max-w-sm">
          <ResponsiveModalHeader>
            <ResponsiveModalTitle>Fyoia AI is now free</ResponsiveModalTitle>
            <ResponsiveModalDescription>
              Fyoia AI is completely free right now. Premium plans coming soon!
            </ResponsiveModalDescription>
          </ResponsiveModalHeader>
        </ResponsiveModalContent>
      </ResponsiveModal>
